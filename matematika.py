...
while True:
    ...
    if bebe == 1:
        ...
        if tasavariant == 1:
            ...
            taseotv1 = num2 / num3
        try:
            vastustase2 = float(input(f'{num2} {["-", "+", "*", "/"][tasavariant - 1]} {num3} = ? '))
        ...
        if tasavariant3 == 1:
            ...
            taseotv1 = num2 / num3
        try:
            vastustase2 = float(input(f'{num2} {["*", "/"][tasavariant3 - 1]} {num3} = ? '))
            if round(taseotv1, 2) == round(vastustase2, 2):
                correct_answers += 1
                print('--------------------------------------')
                print('Molodets! napishi 666 dlja zakritija')
...
if total_questions > 0:
    ...
    print('--------------------------------------')
    print(f'Teie tulemus: {correct_answers}/{total_questions} ({percentage:.2f}%)')
    print(f'Hinne: {hinne}')
    print('--------------------------------------')
else:
